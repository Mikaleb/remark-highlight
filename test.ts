...
const githubFlavor = remark().use(gfm).use(github).use(highlight);

describe('remark-highlight', function () {
    // describe.skip('minimal compiler', function () {
    //     it.skip('replaces == to div in text', async function () {
    //         const tests: Record<string, string> = {
    //             'This is a ==highlighted text==': 'This is 🐶\n',
    ...
    //     it.skip('does not replace emoji-like but not-a-emoji stuffs', async function () {
    //         const tests: Record<string, string> = {
    ...
    //     it.skip('replaces in link text', async function () {
    //         const tests: Record<string, string> = {
    ...
    //     // it.skip('handles an emoji including 2 underscores', async function () {
    ...
    describe('transforms markdown AST with other remark plugins', function () {
        it('replaces == highlight in text with GitHub-Flavored Markdown extensions', async function () {
            const input = 'is a ==with text== .';
            const expected = 'is a <span class="highlight">with text</span> .\n';
